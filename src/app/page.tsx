    ...
    <main className="relative mx-auto flex min-h-full w-full max-w-5xl flex-col px-6 py-10">
      ...
      <header className="relative flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2">
          <img src="/logo.png" alt="" className="h-9 w-9 rounded-md object-cover object-[center_38%]" />
      ...
      <section className="relative mt-14 grid items-center gap-10 lg:grid-cols-2 sl-reveal sl-in" data-sl-reveal>
        ...
        <img
          src="/banner.png"
          alt="SecondLook canvas: Look up, Save, Gap, Follow-up, Brief"
          className="w-full rounded-2xl border border-[var(--line)] bg-white/60 object-cover shadow-[0_18px_50px_rgba(26,26,26,0.08)]"
        />
      </section>
